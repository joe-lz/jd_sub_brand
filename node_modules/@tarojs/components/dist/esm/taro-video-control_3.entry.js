import { r as registerInstance, h, H as Host, g as getElement, c as createEvent } from './core-02b61088.js';
...
const Video = class {
            ...
            if (this.gestureType === 'none') {
                ...
                if (Math.abs(distY) >= Math.abs(distX)) {
                    ...
                    if (this.enableProgressGesture) {
                        ...
                        this.lastPercentage = this.currentTime / (_a = this.duration, (_a !== null && _a !== void 0 ? _a : this._duration));
                    }
                    else {
                        return obj;
                    }
    ...
    render() {
        ...
        return (h(Host, { class: classNames('taro-video-container', {
            ...
            }, ref: dom => (this.videoRef = dom), src: src, autoplay: autoplay, loop: loop, muted: muted, poster: controls ? poster : undefined, playsinline: true, "webkit-playsinline": true, onPlay: this.handlePlay, onPause: this.handlePause, onEnded: this.handleEnded, onTimeUpdate: this.handleTimeUpdate, onError: this.handleError, onDurationChange: this.handleDurationChange, onProgress: this.handleProgress, onLoadedMetaData: this.handleLoadedMetaData }, "\u6682\u65F6\u4E0D\u652F\u6301\u64AD\u653E\u8BE5\u89C6\u9891"), h("taro-video-control", { ref: dom => {
                if (dom) {
                ...
                'taro-video-type-fullscreen': isFullScreen
            }), onClick: this.onClickFullScreenBtn }))), h("taro-video-danmu", { ref: dom => {
                if (dom) {
                    this.danmuRef = dom;
                }
            }, enable: _enableDanmu }), isFirst && showCenterPlayBtn && !isPlaying && (h("div", { class: 'taro-video-cover' }, h("div", { class: 'taro-video-cover-play-button', onClick: this.play }), h("p", { class: 'taro-video-cover-duration' }, durationTime))), h("div", { class: 'taro-video-toast taro-video-toast-volume', ref: dom => {
                if (dom) {
