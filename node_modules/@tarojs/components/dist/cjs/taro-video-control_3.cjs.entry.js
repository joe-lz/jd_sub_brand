...
const core = require('./core-590f5f92.js');
...
const Video = class {
    ...
    render() {
        ...
        return (core.h(core.Host, { class: index$1.classNames('taro-video-container', {
            ...
            }, ref: dom => (this.videoRef = dom), src: src, autoplay: autoplay, loop: loop, muted: muted, poster: controls ? poster : undefined, playsinline: true, "webkit-playsinline": true, onPlay: this.handlePlay, onPause: this.handlePause, onEnded: this.handleEnded, onTimeUpdate: this.handleTimeUpdate, onError: this.handleError, onDurationChange: this.handleDurationChange, onProgress: this.handleProgress, onLoadedMetaData: this.handleLoadedMetaData }, "\u6682\u65F6\u4E0D\u652F\u6301\u64AD\u653E\u8BE5\u89C6\u9891"), core.h("taro-video-control", { ref: dom => {
                if (dom) {
                ...
                'taro-video-type-fullscreen': isFullScreen
            }), onClick: this.onClickFullScreenBtn }))), core.h("taro-video-danmu", { ref: dom => {
                if (dom) {
                    this.danmuRef = dom;
                }
            }, enable: _enableDanmu }), isFirst && showCenterPlayBtn && !isPlaying && (core.h("div", { class: 'taro-video-cover' }, core.h("div", { class: 'taro-video-cover-play-button', onClick: this.play }), core.h("p", { class: 'taro-video-cover-duration' }, durationTime))), core.h("div", { class: 'taro-video-toast taro-video-toast-volume', ref: dom => {
                if (dom) {
