...
exports.default = (ctx) => {
    ctx.registerMethod('generateFrameworkInfo', ({ platform }) => {
        ...
        if (frameworkVersion) {
            ...
            printLog("generate" /* GENERATE */, '框架信息', `${outputRoot}/${frameworkInfoFileName}`);
        }
        else {
            printLog("warning" /* WARNING */, '依赖安装', chalk.red(`项目依赖 ${frameworkName} 未安装，或安装有误！`));
        }
    });
};
//# sourceMappingURL=generateFrameworkInfo.js.map