        ...
        fn({ config }) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (fs.existsSync(quickappJSONPath)) {
                    ...
                    printLog("warning" /* WARNING */, '缺少配置', `检测到项目目录下未添加 ${chalk.bold('project.quickapp.json')} 文件，将使用默认配置，参考文档 https://nervjs.github.io/taro/docs/project-config.html`);
                    quickappJSON = defaultManifestJSON;
                }
                const originalOutputRoot = config.outputRoot;
                config.outputRoot = `${originalOutputRoot}/src`;
                // 准备 miniRunner 参数
                const miniRunnerOpts = Object.assign(Object.assign({}, config), { nodeModulesPath, buildAdapter: config.platform, isBuildPlugin: false, globalObject: 'global', fileType: {
                        templ: '.ux',
                        style: '.css',
                        config: '.json',
                        script: '.js'
                    }, isUseComponentBuildPage: false, quickappJSON, isBuildQuickapp: true, templateAdapter: {
                        if: 'if',
                        else: 'else',
                        elseif: 'elif',
                        for: 'for',
                        ...
                        key: 'key',
                        type: 'quickapp'
                    }, isSupportRecursive: true, isSupportXS: false });
...
//# sourceMappingURL=quickapp.js.map