    ...
    ctx.registerPlatform({
        ...
        fn({ config }) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                // 准备 miniRunner 参数
                const miniRunnerOpts = Object.assign(Object.assign({}, config), { nodeModulesPath, buildAdapter: config.platform, isBuildPlugin: false, globalObject: 'qq', fileType: {
                        templ: '.qml',
                        style: '.qss',
                        config: '.json',
                        script: '.js',
